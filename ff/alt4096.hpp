...
#define TO_CUDA_T(limb64) (uint32_t)(limb64), (uint32_t)(limb64>>32)
    ...
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_P[128];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_RR[128];   /* (1<<512)%P */
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_one[128];  /* (1<<256)%P */
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_Px4[128];  /* left-aligned value of the modulus */
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_MODn[128];
    ...
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_r[128];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_rRR[128];  /* (1<<512)%P */
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_rone[128]; /* (1<<256)%P */
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_rx4[128];  /* left-aligned value of the modulus */
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_MODN[128];
