...
#ifndef __SPPARK_FF_ALT6142_HPP__
#define __SPPARK_FF_ALT6142_HPP__
...
#define TO_CUDA_T(limb64) (uint32_t)(limb64), (uint32_t)(limb64>>32)
    ...
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_P[192];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_RR[192];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_one[192];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_Px4[192];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_MODn[192];
    extern __device__ __constant__ uint32_t ALT_BN128_M0;

    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_r[192];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_rRR[192];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_rone[192];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_rx4[192];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_MODN[192];
    extern __device__ __constant__ uint32_t ALT_BN128_m0;

    // device-side field types
    typedef mont_t<6142, device::ALT_BN128_P,
                device::ALT_BN128_M0,
                device::ALT_BN128_RR,
    ...
    typedef mont_t<6142, device::ALT_BN128_r,
                device::ALT_BN128_m0,
    ...
    static constexpr int LAMBDA = 6142;
}
...
#endif  // __SPPARK_FF_ALT6142_HPP__
