// This TU provides the single definition of ALT1024 device constants.
...
__device__ __constant__ __align__(16) const uint32_t ALT_BN128_P[32] = {
...
__device__ __constant__ __align__(16) const uint32_t ALT_BN128_RR[32] = { /* (1<<512)%P */
...
__device__ __constant__ __align__(16) const uint32_t ALT_BN128_one[32] = { /* (1<<256)%P */
...
__device__ __constant__ __align__(16) const uint32_t ALT_BN128_Px4[32] = { /* left-aligned value of the modulus */
...
__device__ __constant__ __align__(16) const uint32_t ALT_BN128_MODn[32] = {
...
__device__ __constant__ uint32_t ALT_BN128_M0 = 0x45ff7753;

__device__ __constant__ __align__(16) const uint32_t ALT_BN128_r[32] = {
...
__device__ __constant__ __align__(16) const uint32_t ALT_BN128_rRR[32] = { /* (1<<512)%P */
...
__device__ __constant__ __align__(16) const uint32_t ALT_BN128_rone[32] = { /* (1<<256)%P */
...
__device__ __constant__ __align__(16) const uint32_t ALT_BN128_rx4[32] = { /* left-aligned value of the modulus */
...
__device__ __constant__ uint32_t ALT_BN128_m0 = 0xd074050f;
