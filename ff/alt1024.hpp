...
#define TO_CUDA_T(limb64) (uint32_t)(limb64), (uint32_t)(limb64>>32)
    ...
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_P[32];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_RR[32];   /* (1<<512)%P */
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_one[32];  /* (1<<256)%P */
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_Px4[32];  /* left-aligned value of the modulus */
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_MODn[32];
    ...
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_r[32];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_rRR[32];  /* (1<<512)%P */
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_rone[32]; /* (1<<256)%P */
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_rx4[32];  /* left-aligned value of the modulus */
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_MODN[32];
