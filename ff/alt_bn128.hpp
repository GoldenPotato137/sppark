...
#define TO_CUDA_T(limb64) (uint32_t)(limb64), (uint32_t)(limb64>>32)
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_P[8];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_RR[8];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_one[8];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_Px4[8];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_MODn[8];
    extern __device__ __constant__ const uint32_t ALT_BN128_M0;

    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_r[8];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_rRR[8];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_rone[8];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_rx4[8];
    extern __device__ __constant__ __align__(16) const uint32_t ALT_BN128_MODN[8];
    extern __device__ __constant__ const uint32_t ALT_BN128_m0;
