...
#define TO_CUDA_T(limb64) (uint32_t)(limb64), (uint32_t)(limb64>>32)
    extern __device__ __constant__ __align__(16) const uint32_t BLS12_377_P[12];
    extern __device__ __constant__ __align__(16) const uint32_t BLS12_377_RR[12];
    extern __device__ __constant__ __align__(16) const uint32_t BLS12_377_one[12];
    extern __device__ __constant__ __align__(16) const uint32_t BLS12_381_Px128[12];
    extern __device__ __constant__ uint32_t BLS12_377_M0;

    extern __device__ __constant__ __align__(16) const uint32_t BLS12_377_r[8];
    extern __device__ __constant__ __align__(16) const uint32_t BLS12_377_rRR[8];
    extern __device__ __constant__ __align__(16) const uint32_t BLS12_377_rone[8];
    extern __device__ __constant__ __align__(16) const uint32_t BLS12_377_rx8[8];
    extern __device__ __constant__ uint32_t BLS12_377_m0;
    ...
    static constexpr int LAMBDA = 253;
}
#endif
...
typedef blst_384_t<377, host::BLS12_377_P, 0x8508bfffffffffffu,
                        host::BLS12_377_RR, host::BLS12_377_ONE> fp_mont;
struct fp_t : public fp_mont {
    using mem_t = fp_t;
    inline fp_t() {}
...
typedef blst_256_t<253, host::BLS12_377_r, 0xa117fffffffffffu,
                        host::BLS12_377_rRR, host::BLS12_377_rONE> fr_mont;
struct fr_t : public fr_mont {
    using mem_t = fr_t;
    inline fr_t() {}
